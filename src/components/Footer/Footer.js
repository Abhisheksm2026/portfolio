    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-section">
          <h3 className="footer-logo">AM</h3>
          <p className="footer-description">
            Creative UI/UX designer passionate about visual storytelling and brand identity.
        ...
        <div className="footer-section">
          ...
          <div className="footer-social">
            {/* Replace these href with your actual profile links later */}
          ...
          <div className="footer-email">
            ...
            <a href="mailto:abhishekmalangaonkar4@gmail.com">abhishekmalangaonkar4@gmail.com</a>
          </div>
        </div>

        <div className="footer-section">
          <h4>Newsletter</h4>
          <p>Get the latest updates on my work.</p>
      ...
      <div className="footer-bottom">
        <p>&copy; {currentYear} Abhishek Malangaonkar. All rights reserved.</p>
      </div>
    </footer>
  );
};
